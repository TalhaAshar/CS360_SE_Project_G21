...
const SignUp = () => (
    ...
    <Container>
        ...
        <BottomRectangle>
            <svg style={{marginTop:'5px',marginBottom:"0px", borderRadius:"16px"}}width="420" height="208" viewBox="0 0 411 208" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <LogInlink>Already Member? <strong>Log In</strong> </LogInlink>
        </BottomRectangle>
    </Container>
  );
