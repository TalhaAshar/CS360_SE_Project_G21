  ...
  render(){
    return(
        <form onSubmit={this.handleSubmit}>
          ...
          <input type="password" name="password" required minLength="8" maxLength="32" style={{width: "380px", height: "45px", fontSize: "24px", borderColor: "#2F80ED", borderRadius: "14px", padding:"10px", outline: "none"}} onChange={this.handleChange} /><br/>
